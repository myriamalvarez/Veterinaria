...
namespace Veterinaria.Web.Controllers
{
    public class PropietariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Dni,Nombre,Apellido,Telefono,direccion")] Propietario propietario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Dni,Nombre,Apellido,Telefono,direccion")] Propietario propietario)
        {
